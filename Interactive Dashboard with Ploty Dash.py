...
def get_scatter_chart(entered_site,payload):
    ...
    if entered_site=='ALL':
        ...
        fig=px.scatter(mask_filtered,x='Payload Mass (kg)',y='class',color='Booster Version Category',title=f"Correlation between Payload and Success for site {entered_site}")
        return fig
